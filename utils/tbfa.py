...
class SneakyBFA(object):
    def __init__(self, criterion, C, fc, k_top=10):
        ...
        self.loss = 0
        self.C = C
        # fc number of layers before FC layer
        self.fc = fc
    ...
    def progressive_bit_search12(self, model, data, target, data1, target1):
        '''
    ...
    def progressive_bit_search3(self, model, data, target, data1, target1):
        '''
    ...
    def progressive_bit_search4(self, model, data, target, data1, target1, args):
        if args.ocm:
